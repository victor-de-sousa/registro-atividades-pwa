...
const REVERSE_URL = import.meta.env.VITE_GEOCODING_BASE_URL ?? 'https://nominatim.openstreetmap.org/reverse'
...
function writeCache(key, value) {
    try {
        localStorage.getItem(`${CACHE_PREFIX}${key}`, JSON.stringify(value))
    } catch {
        return
    }
}
